 ...
 */
public class RandomDelayShipSpawner extends ShipSpawner {
    ...
    public RandomDelayShipSpawner(RootActivity activity, float firstSpawnIn, float spawnDelay, int number) {
        ...
        public void onTimePassed(final TimerHandler timerHandler) {
            activity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    delay = MIN_SPAWN_DELAY + new Random().nextFloat() * spawnDelay;
                    Log.d("1log", "new ship in(r)..." + delay);
